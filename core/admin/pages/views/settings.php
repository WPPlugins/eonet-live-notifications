        ...
        ?>
            ...
            <form id="eo_admin_settings_form" method="post" action="<?php echo get_admin_url(). 'admin.php?page=eonet&eo_tab=settings' ?>" class="eo_form">
                                    ...
                                    <div class="eo_tab_inner_content">
                                        <div class="eonet_padding">
                                            <div class="eo_alert eo_alert_info">
                                                <h4><?php _e('No option available at this moment... ','eonet-live-notifications'); ?></h4>
                                                <p><?php _e('We\'re still working on this component options. Feel free to get in touch with us for any option idea. Options will be coming in the premium version.', 'eonet-live-notifications'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="eo_tab_inner_footer">
                ...
                <a href="javascript:void(0);" id="eo_admin_settings_reset_trigger" class="eo_btn eo_btn_default">
                    <?php _e('Reset Settings', 'eonet-live-notifications'); ?>
                </a>
                ...
                (function ($) {
	                ...
	                setTimeout(function(){
	                    var data = {
		                    ...
		                    message = "<?php _e("Are you sure? This can't be undone. All your Eonet settings will be erased.",'eonet-live-notifications') ?>";;
