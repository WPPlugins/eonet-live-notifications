...
class EonetOptions {
	...
	static public function getSubmit($type = 'new', $label = '') {
		...
		if($type == 'delete') {
			$icon = 'fa-trash-o';
			$text = __('Delete', 'eonet-live-notifications');
		}
		elseif ($type == 'new') {
			$icon = 'fa-pencil-square-o';
			$text = __('New', 'eonet-live-notifications');
		} else {
			$icon = 'fa-check-circle';
			$text = __('Save', 'eonet-live-notifications');
		}
    ...
    static protected function renderFieldTypeUpload( $option, $option_saved ) {
        ...
        $html .= '<div class="eo_field_upload_wrapper">';
            ...
            // Button :
            $html .= '<button data-eo-name="eo_field_' . $option['name'] . '" name="eo_field_' . $option['name'] . '_trigger" class="eo_btn_upload_wp eo_btn eo_btn_default"><i class="fa fa-picture-o"></i> '.__('Choose an Image', 'eonet-live-notifications').'</button>';
        $html .= '</div>';
